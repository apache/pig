...
public class OptimizerException extends VisitorException {
     ...
     */
    public OptimizerException(String message, int errCode) {
     ...
     * @param cause - The cause (which is saved for later retrieval by the <link>Throwable.getCause()</link> method) indicating the source of this exception. A null value is permitted, and indicates that the cause is nonexistent or unknown. 
     */
    public OptimizerException(String message, int errCode, Throwable cause) {
     ...
     */
    public OptimizerException(String message, int errCode, byte errSrc) {
     ...
     */ 
    public OptimizerException(String message, int errCode, boolean retry) {
