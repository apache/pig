...
public class BadUdf extends EvalFunc<DataBag>
{
...
//fields but then 3 fields are written out below. 
        ...
        {
            throw new IOException("Exception occurred in BadUdf::exec."+e); // Hoping that it will
//crash the script upon any exception 
        }
    }
}
