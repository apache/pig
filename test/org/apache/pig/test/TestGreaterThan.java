...
public class TestGreaterThan extends junit.framework.TestCase {
    ...
    private static boolean test(byte type) throws ExecException {
        Random r = new Random();
        ...
        GreaterThanExpr g = (GreaterThanExpr) GenPhyOp.compGreaterThanExpr();
        g.setLhs(lt);
        g.setRhs(rt);
    ...
    public void testOperator() throws ExecException {
        ...
        // System.out.println("Testing Greater Than Expression:");
