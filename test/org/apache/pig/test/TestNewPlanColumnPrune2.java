...
public class TestNewPlanColumnPrune2 extends TestCase {
    ...
    public void testLoadForEach1() throws Exception{
        pigServer.registerQuery("A = load '"+ Util.generateURI(tmpFile1.toString(), pigServer.getPigContext()) + "' as (a0, a1:int, a2:int);");       
    ...
    public void testLoadForEach2() throws Exception{
        pigServer.registerQuery("A = load '"+ Util.generateURI(tmpFile1.toString(), pigServer.getPigContext()) + "' as (a0:int, a1, a2:int);");       
    ...
    public void testLoadForEach3() throws Exception{
        pigServer.registerQuery("A = load '"+ Util.generateURI(tmpFile1.toString(), pigServer.getPigContext()) + "' as (a0:int, a1:int, a2);");
    ...
    public void testCross1() throws Exception {
        ...
        assertTrue(checkLogFileMessage(new String[]{"Loader for A is pruned. Load fields [0]", 
            "Loader for B is pruned. Load fields [0]"}));
    }
    ...
    public void testUnion1() throws Exception {
        ...
        assertTrue(checkLogFileMessage(new String[]{"Loader for A is pruned. Load fields [0,2]", 
            "Loader for B is pruned. Load fields [0,2]"}));
    }
    ...
    public void testComplex1() throws Exception {
        ...
        assertTrue(checkLogFileMessage(new String[]{"Loader for A is pruned. Load fields [0,2]", 
                "Loader for B is pruned. Load fields [0,2,3]"}));
    }
    ...
    public void testSharedSchemaObject() throws Exception {
        ...
        assertTrue(iter.hasNext());
        Tuple t = iter.next();
        assertTrue(t.toString().contains("2#1"));
    ...
    public void testSplit3() throws Exception {
        pigServer.registerQuery("A = load '"+ Util.generateURI(tmpFile1.toString(), pigServer.getPigContext()) + "' AS (a0, a1, a2);");
        pigServer.registerQuery("A2 = foreach A generate a0, a1, (int)a2;");
        pigServer.registerQuery("split A2 into B if a2==3, C if a2<3;");
        pigServer.registerQuery("C = foreach B generate $2;");
    ...
    public void testUnionMixedPruning() throws Exception {
        ...
        pigServer.registerQuery("E = foreach D generate $0, $2;");
        pigServer.explain("E", System.out);
        Iterator<Tuple> iter = pigServer.openIterator("E");
        Collection<String> results = new HashSet<String>();
        results.add("(1,3)");
        results.add("(2,2)");
    ...
    public void testForEachFlatten() throws Exception {
        ...
        assertTrue(checkLogFileMessage(new String[]{"Loader for A is pruned. Load fields [0,2,3]"}));
    }
