...
public class TezCompilerException extends VisitorException {
     ...
     */
    public TezCompilerException(String message) {
        super(message);
    }
     ...
     */
    public TezCompilerException(Throwable cause) {
        super(cause);
    }
     ...
     * nonexistent or unknown.
     */
    public TezCompilerException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public TezCompilerException(String message, int errCode) {
     ...
     * nonexistent or unknown.
     */
    public TezCompilerException(String message, int errCode, Throwable cause) {
     ...
     */
    public TezCompilerException(String message, int errCode, byte errSrc) {
     ...
     */
    public TezCompilerException(String message, int errCode, boolean retry) {
    ...
    /**
     * Create a new TezCompilerException with the specified message, error code,
