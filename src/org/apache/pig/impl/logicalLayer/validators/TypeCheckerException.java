...
public class TypeCheckerException extends VisitorException {
     ...
     */
    public TypeCheckerException(String message, int errCode) {
     ...
     * @param cause - The cause (which is saved for later retrieval by the <link>Throwable.getCause()</link> method) indicating the source of this exception. A null value is permitted, and indicates that the cause is nonexistent or unknown. 
     */
    public TypeCheckerException(String message, int errCode, Throwable cause) {
     ...
     */ 
    public TypeCheckerException(String message, int errCode, boolean retry) {
