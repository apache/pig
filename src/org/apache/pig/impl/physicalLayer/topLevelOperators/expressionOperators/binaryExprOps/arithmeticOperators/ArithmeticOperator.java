...
public abstract class ArithmeticOperator extends BinaryExpressionOperator {

    public ArithmeticOperator(OperatorKey k) {
        super(k);
    }

    public ArithmeticOperator(OperatorKey k, int rp) {
        super(k, rp);
    }
