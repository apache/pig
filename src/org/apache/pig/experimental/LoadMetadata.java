...
public interface LoadMetadata {
     ...
     */
    ResourceSchema getSchema(String location, Configuration conf) throws IOException;
     ...
     */
    void setParitionFilter(OperatorPlan<Operator<PlanVisitor<?,?>>> plan) throws IOException;
