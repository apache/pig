...
public class ResourceSchema {
    ...
    public Map<String, Integer> byName = new HashMap<String, Integer>();
    ...
    public ResourceSchema(Schema pigSchema) {
        ...
        byName = new HashMap<String, Integer>(fields.length);
        for (int i=0; i<fields.length; i++) {
            fields[i] = new ResourceFieldSchema(pigSchemaFields.get(i));
            byName.put(fields[i].getName(), i);
        }
    ...
    public  ResourceSchema setByName(Map<String, Integer> byName) {
        this.byName = byName;
        return this;
    }
