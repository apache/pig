...
CREATE TABLE owl_columnschema (
    ...
    UNIQUE KEY      (cs_sid, cs_name)
);

CREATE TABLE owl_table (
    ot_id                   INTEGER AUTO_INCREMENT,
    ...
    UNIQUE KEY              (ot_database_id, ot_name)
);
...
CREATE TABLE owl_dataelement (
    ...
    UNIQUE KEY               (de_owltable_id, de_location)
);


CREATE TABLE owl_partitionkey (
    pak_id                  INTEGER AUTO_INCREMENT,
    ...
    UNIQUE KEY              (pak_owltable_id, pak_name),
    UNIQUE KEY              (pak_owltable_id, pak_partition_level)
);


CREATE TABLE owl_propertykey (
    prk_id                  INTEGER AUTO_INCREMENT,
    ...
    UNIQUE KEY              (prk_owltable_id, prk_name)
);


CREATE TABLE owl_globalkey (
    gk_id                   INTEGER AUTO_INCREMENT,
...
CREATE TABLE owl_tablekeyvalue (
    otkv_id                INTEGER AUTO_INCREMENT,
