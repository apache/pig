...
public class TestMultipleOutputs4 {
  ...
  public static void getTablePaths(String myMultiLocs) {
    ...
    while (st.hasMoreElements()) {
      ...
      if (whichCluster.equalsIgnoreCase("miniCluster")) {
        ...
        //in mini, token: file:/homes/jing1234/grid/multipleoutput/pig-table/contrib/zebra/ustest3
        if (count == 1)
          strTable1 = token;
        if (count == 2)
          strTable2 = token;
  ...
  public static void checkTableExists(boolean expected, String strDir) throws IOException{
     ...
     //the dir : /user/hadoopqa/ustest3
      //the dir : /homes/jing1234/grid/multipleoutput/pig-table/contrib/zebra/ustest3
